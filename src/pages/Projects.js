...
const Project = ({title, type, img, link, github}) => {
    ...
    return(
        ...
        border-solid border-dark bg-light p-6 relative xs:p-4
        '>
             <div className='absolute top-0 -right-3 -z-10 w-[101%] h-[103%] rounded-[2rem] bg-dark
        ...
        '/>
            ...
            <span className='text-primary font-medium text-1xl lg:text-lg md:text-base'>{type}</span>
            <Link href={link} target="_blank" className='hover:underline underline-offset-2'>
...
const Projects = () => {
  return (
    <>
     <Head>
        <title>Nkosinathi Tolom | Projects Page</title>
        ...
        <Layout pt-16>
            ...
            <div className='grid grid-cols-12 gap-24 gap-y-32 xl:gap-x-16 lg:gap-x-8 md:gap-y-24 sm:gap-x-0'>
                <div className='col-span-12'>
                    ...
                    img={project1}
                    summary="A personal porfolio web application using React, Next13, Tailwind Css, Framer-motion and
                    it shows a nice subtle portfolio design that is very easy on the eyes and completely responsive."
                    link="/"
                    github="/"
