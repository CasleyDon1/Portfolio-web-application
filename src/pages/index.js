  ...
  return (
    <>
      ...
      <TransitionEffect />
       <div className='flex items-center text-dark w-full min-h-screen'>
        ...
        <div className='flex items-center justify-between w-full lg:flex-col'>
          <div className='w-1/2 w-full'>
            <Image src={profilePic} alt="NkostinathiTolom" className='w-full pt-0 h-auto lg:hidden md:inline-block md:w-full' 
            priority
            ...
            <Link href="mailto:Casleynkosi@gmail.com" target={"_blank"}
       ...
       <HireMe />
       <div className='absolute right-8 -bottom-10 inline-block w-20 md:hidden'>
        <Image src={lightBulb} alt="NKosinathi Tolom" className='w-full h-auto' />
       </div>
    </div>
    </>
  )
